...
interface INodeData {
  ...
  actions?: any, category?: string, originOfTerminal?: any, label?: any;
}
...
export class AppComponent {
  ...
  addIvrNode(obj) {
    ...
    let parentOfTerminalNode = this.nodeDataArray.find((element) => {
    ...
    switch (obj.name) {
      ...
      case "Terminal":
        ...
        obj.isGroup = true;
        obj.label = parentOfTerminalNode.question + (++this.counter);
        obj.name=obj.label
        console.log(obj.question,obj.label)
        break;
    ...
    // console.log(parentOfTerminalNode);
